...
public class ResearchService {
    @Value("${gemini.api.url}") //Inject the value of this property from the application’s configuration into this field at runtime.
    ...
    private String buildPrompt(ResearchRequest request){
        String op = request.getOperation() == null ? "" : request.getOperation().trim().toLowerCase();
